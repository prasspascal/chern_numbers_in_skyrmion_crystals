...
% -- topological phase transitions by tuning phase/ferromagnetic degree of freedom
...
\\
Ch_{\lbrace t_1,t_2 \rbrace} &= n_{\lbrace t_1,t_2\rbrace} \label{eq:Chernnumbers2}%    % + \vartheta n_{\lbrace \rbrace} 
\\
...
\end{align}
% In particular, one can see from this that
% \begin{align}
%    - \partial_\theta^2   Ch_{\emptyset}(g) =  Ch_{\lbrace \tau_1, \tau_2, u_1, u_2 \rbrace}(g) .
% \end{align}
